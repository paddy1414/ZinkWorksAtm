...
import org.patricknorton.zinkworks.ZinkWorksAtm.rest.AtmResourceRest;
...
class AtmResourceTest {
    ...
    void testLogin() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/web/profile?accountNum=123456789&pin=1234"))
                .andExpect(status().isOk())
                .andExpect(view().name("profile"));
    }
    @Test
    void testLoginWrongUser() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.post("/web/profile?accountNum=12345678911&pin=1234"))
                .andExpect(status().isOk())
    ...
    void testGetWindraw() throws Exception{
        mockMvc.perform(MockMvcRequestBuilders.post("/web/withdraw?accountNum=123456789&pin=1234&withdraw=123"))
                .andExpect(status().isOk())
                .andExpect(view().name("profile"));
    }
